...
using ModuleList = std::list<std::unique_ptr<IModule<PluginContextType>>>;
...
public:
     ...
     * Register a module.
     */
    template <PluginModule<PluginContextType> ModuleType>
    size_t registerModule(PluginContextType& plugin_ctx)
    {
