...
namespace ietf::sys::sub::oper {
     ...
     *
     */
    sr::ErrorCode DnsSearchOperGetCb::operator()(
     ...
     *
     */
    sr::ErrorCode DnsServerNameOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsServerUdpAndTcpAddressOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsServerUdpAndTcpPortOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsServerUdpAndTcpOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsServerOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsOptionsTimeoutOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsOptionsAttemptsOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsOptionsOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
     ...
     *
     */
    sr::ErrorCode DnsOperGetCb::operator()(
        sr::Session session, uint32_t subscriptionId, std::string_view moduleName,
        std::optional<std::string_view> subXPath,
        std::optional<std::string_view> requestXPath, uint32_t requestId,
        std::optional<ly::DataNode>& output)
...
void DnsResolverValuesApplier::applyDatastoreValues(sysrepo::Session& session) {
    sr::Datastore active_datastore = session.activeDatastore();
    session.switchDatastore(sr::Datastore::Running);

    session.deleteItem("/ietf-system:system/dns-resolver");
    session.applyChanges();

    ietf::sys::dns::DnsSearchList dns_search_list;
    ietf::sys::dns::DnsServerList dns_server_list;

    try {

        dns_search_list.loadFromSystem();
        dns_server_list.loadFromSystem();

        for (auto& iter : dns_search_list) {
            session.setItem("/ietf-system:system/dns-resolver[search='" + iter.Domain + "']", std::nullopt);
        }

        for (auto& dns_server : dns_server_list) {
            session.setItem("/ietf-system:system/dns-resolver/server[name='" + dns_server.Name + "']/udp-and-tcp/address", dns_server.Address->asString());

            if (dns_server.Port != 0) {
                session.setItem("/ietf-system:system/dns-resolver/server[name='" + dns_server.Name + "']/port", std::to_string(dns_server.Port));
            }
        }
    ...
    : srpc::IModule<ietf::sys::PluginContext>(plugin_ctx)
{
    ...
    this->addValueApplier<DnsResolverValuesApplier>();
}
