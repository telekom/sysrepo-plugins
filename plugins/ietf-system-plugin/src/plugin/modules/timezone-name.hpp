...
public:
     ...
     *
     */
    ClockTimezoneUtcOffsetOperGetCb(
...
public:
     ...
     *
     */
    ClockTimezoneNameModuleChangeCb(
...
public:
     ...
     *
     */
    ClockTimezoneUtcOffsetModuleChangeCb(
        std::shared_ptr<TimezoneModuleChangesContext> ctx);
...
/**
 * @brief Checker used to check if ietf-system/system/clock/timezone* value is
...
/**
 * @brief Applier used to apply /ietf-system:system/clock/timezone* value from
 * the datastore to the system.
 */
class TimezoneValueApplier : public srpc::IDatastoreApplier {
    /**
